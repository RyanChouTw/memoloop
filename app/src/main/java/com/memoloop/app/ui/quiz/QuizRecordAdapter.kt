...
class QuizRecordAdapter : ListAdapter<QuizResult, QuizRecordAdapter.ViewHolder>(DIFF) {
    ...
    companion object {
        val DIFF = object : DiffUtil.ItemCallback<QuizResult>() {
            override fun areItemsTheSame(a: QuizResult, b: QuizResult) = a.id == b.id
            override fun areContentsTheSame(a: QuizResult, b: QuizResult) = a == b
        }
    }
}
